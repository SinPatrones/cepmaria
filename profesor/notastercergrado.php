...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            $sql_cursos = "SELECT cursos.* FROM cursos INNER JOIN cursoprofesores ON cursos.id_curso=cursoprofesores.id_curso WHERE cursos.grado_curso='TERCERO' AND cursoprofesores.id_profesor=$id_usuario";
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php
                                    $sql_alumnos = "SELECT datosusuarios.* FROM datosusuarios INNER JOIN matriculas ON datosusuarios.id_datosusuario=matriculas.id_alumno WHERE matriculas.grado_matricula='TERCERO'";
                                    $con->connect();
