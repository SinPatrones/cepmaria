                                                        ...
                                                        <div class="table-responsive table-bordered">
                                                            <table class="table">
                                                                ...
                                                                for ($k = 0; $k < sizeof($array_alumnos); $k++){
                                                                    $primero = $array_alumnos[$k]['primer_bimestre'];
                                                                    ...
                                                                    $promedio = round(($primero + $segundo + $tercero + $cuarto) / 4);
                                                                    ?>
                                                                    <form action="actions/guardarnota.php" method="post">
                                                                        <tr>
                                                                            ...
                                                                            <form action="actions/guardarnota.php" method="post">
                                                                                <td align="center">
                                                                                    <input type="number" name="primerbimestre" value="<?php echo $primero; ?>" max="20" min="0">
