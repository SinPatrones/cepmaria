    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Lista de Alumnos de Cuarto Grado</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                $sql_esta_en_grado = "SELECT * FROM cursos INNER JOIN cursoprofesores ON cursos.id_curso=cursoprofesores.id_curso WHERE cursoprofesores.id_profesor=".strval($id_usuario)." AND cursos.grado_curso='CUARTO'";
                $con->connect();
                $result_esta_grado = $con->query($sql_esta_en_grado);
                $con->close();
                if ($con->getnumrows($result_esta_grado)>0){

                    $sql_lista_grado = "SELECT * FROM matriculas INNER JOIN datosusuarios ON matriculas.id_alumno=datosusuarios.id_datosusuario WHERE matriculas.grado_matricula='CUARTO' ORDER BY datosusuarios.apellidos ASC";
                ...
                <?php
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h3>Usted no esta asignado para ningun curso de la educación de Cuarto grado</h3>
                        </div>
                    </div>
                <?php
                }
