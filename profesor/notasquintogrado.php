...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            $sql_cursos = "SELECT cursos.* FROM cursos INNER JOIN cursoprofesores ON cursos.id_curso=cursoprofesores.id_curso WHERE cursos.grado_curso='QUINTO' AND cursoprofesores.id_profesor=$id_usuario";
                                                    ...
                                                    <div class="table-responsive table-bordered">
                                                        <table class="table">
                                                            ...
                                                            for ($k = 0; $k < sizeof($array_alumnos); $k++){
                                                                $QUINTO = $array_alumnos[$k]['primer_bimestre'];
                                                                ...
                                                                $promedio = round(($QUINTO + $segundo + $tercero + $cuarto) / 4);
                                                                ?>
                                                                <form action="actions/guardarnota.php" method="post">
                                                                    <tr>
                                                                        ...
                                                                        <form action="actions/guardarnota.php" method="post">
                                                                            <td align="center">
                                                                                <input type="number" name="primerbimestre" value="<?php echo $QUINTO; ?>" max="20" min="0">
                                                                                ...
                                                                                <input type="text" style="display: none" value="5" name="grado">
                                                                                <br>
